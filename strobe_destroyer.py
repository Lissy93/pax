...
def startStream(inputFile, outputFile, codecName):
    ...
    inputVideo, outputVideo = captureUtils.setupStream(inputFile, outputFile, codecName)
...
def main(argv):
    ...
    (success, (inputFile, outputFile, codecName)) = argumentParser.parseArguments(argv)
